...
)
{
    ...
    if (!le_avdata_UnpackAccessType( &_msgBufPtr, &_msgBufSize,
                                               &accessType ))
    {
        goto error_unpack;
    }
...
)
{
    ...
    LE_ASSERT(le_pack_PackString( &_msgBufPtr, &_msgBufSize,
                                  path, 511 ));
    LE_ASSERT(le_avdata_PackAccessMode( &_msgBufPtr, &_msgBufSize,
                                                  accessMode ));
...
)
{
    ...
    // Pack the input parameters
    LE_ASSERT(le_avdata_PackNamespace( &_msgBufPtr, &_msgBufSize,
                                                  _namespace ));
...
)
{
    ...
    if (!le_avdata_UnpackPushStatus( &_msgBufPtr, &_msgBufSize,
                                               &status ))
    {
        goto error_unpack;
    }
...
)
{
    ...
    if (!le_avdata_UnpackSessionState( &_msgBufPtr, &_msgBufSize,
                                               &sessionState ))
    {
        goto error_unpack;
    }
