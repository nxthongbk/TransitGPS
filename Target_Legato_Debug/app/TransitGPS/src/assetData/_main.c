...
LE_SHARED const char* _assetDataComponent_le_wifiAp_ServiceInstanceName = "assetData.assetDataComponent.le_wifiAp";
LE_SHARED const char* _assetDataComponent_le_posCtrl_ServiceInstanceName = "assetData.assetDataComponent.le_posCtrl";
LE_SHARED const char* _assetDataComponent_le_pos_ServiceInstanceName = "assetData.assetDataComponent.le_pos";
